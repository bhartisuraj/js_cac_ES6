...
// console.log(marvel_heros[3][1]); // To access value inside index 3.1(flash)
...
// console.log(Array.from({ name: "Suraj" })); // Give empty array []. Here we have to define we should make arrays from keys or values.

// let score1 = 100;
// let score2 = 200;
// let score3 = 300;

// console.log(Array.of(score1, score2, score3)); // This line of code will convert Variables/elements to Array list.